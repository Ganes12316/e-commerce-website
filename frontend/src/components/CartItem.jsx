						...
						<button
							className='h-8 w-8 flex items-center justify-center rounded-md border
							 border-gray-600 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2
							  focus:ring-emerald-500 text-white font-bold text-xl'
							onClick={() => updateQuantity(item._id, item.quantity - 1)}
						>
							−
						</button>
						<span className='font-semibold text-lg min-w-[30px] text-center text-white'>
							{item.quantity}
						</span>
						<button
							className='h-8 w-8 flex items-center justify-center rounded-md border
							 border-gray-600 bg-gray-700 hover:bg-gray-600 focus:outline-none 
							focus:ring-2 focus:ring-emerald-500 text-white font-bold text-xl'
							onClick={() => updateQuantity(item._id, item.quantity + 1)}
						>
							+
						</button>
